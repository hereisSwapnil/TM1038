  ...
  return (
    <>
      ...
      <div ref={about} className="about">
        <p className="mission-line">Our Mission</p>
        <h1 className="mission-heading">
          Empowering People Through Technology
        </h1>
        <p className="mission-text">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque
          auctor ac orci at interdum. Sed ac libero non justo rhoncus finibus.
          Nullam convallis, turpis eu fermentum tristique, elit tortor venenatis
